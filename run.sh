...
# python run.py    -dataset_train=calm_flat_5pct_curve_6m_1y -dataset_eval=calm_flat_5pct_curve_6m_1y -eval_offset=45000 -train_sim=45000 -eval_sim=5000 -spread_train=0.01 -spread_eval=0.01 -critic=qr-huber -obj_func=cvar
